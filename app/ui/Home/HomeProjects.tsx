...
export default function HomeProjects() {
  ...
  return (
    ...
    >
      <div className="relative p-8 sm:p-10 lg:p-12 rounded-3xl bg-linear-to-br from-white/[0.03] to-white/[0.01] backdrop-blur-xl border border-white/10 shadow-2xl overflow-hidden">
