...
import { ColorClasses, HomeData } from "@/app/lib/home.data";
  ...
  return (
    ...
    >
      <div className="relative p-8 sm:p-10 lg:p-12 rounded-3xl bg-linear-to-br from-white/3 to-white/1 backdrop-blur-xl border border-white/10 shadow-2xl overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-linear-to-br from-violet-500/5 via-blue-500/5 to-purple-500/5 blur-3xl rounded-full" />
        ...
        <div className="relative space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {goals.map((goal, index) => (
              ...
              >
                <Card className="h-full bg-white/2 backdrop-blur-xl border border-white/10 shadow-xl hover:shadow-2xl hover:border-white/20 transition-all duration-500 overflow-hidden group">
                  {/* Gradient glow on hover */}
                  <div className={`absolute inset-0 bg-linear-to-br ${goal.glow} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                    ...
                    <div className="pt-4">
                      <div className="h-1 bg-white/10 rounded-full overflow-hidden">
                        <motion.div
                          ...
                          className={`h-full bg-linear-to-r ${goal.glow.replace('/20', '/60')}`}
                        />
                      </div>
                    </div>
                  </CardContent>
