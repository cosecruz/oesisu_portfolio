...
export default function MeContent(): JSX.Element {
  ...
  return (
    <main className="flex flex-col min-h-screen pb-20">
      ...
      <DetailSection id="education" title="Education" icon={GraduationCap} iconColor="blue" items={educationData} layout="timeline" maxWidth="xl" />
      <DetailSection id="experience" title="Professional Experience" icon={Briefcase} iconColor="violet" items={experienceData} layout="timeline" maxWidth="xl" />
      <DetailSection id="projects" title="Featured Projects" icon={Rocket} iconColor="blue" items={projectsData} layout="timeline" maxWidth="xl" />
      <DetailSection id="achievements" title="Achievements & Certifications" icon={Award} iconColor="violet" items={achievementsData} layout="grid" maxWidth="xl" />

      {/* Life Values & Hobbies */}
      <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={containerVariants} className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
